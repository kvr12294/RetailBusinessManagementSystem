create table employees(eid char(3) primary key,ename varchar2(15),etelephone char(12));

create table customers(cid char(4) primary key,cname varchar2(15),ctelephone char(12),visits_made number(4),last_visit_date date);
...
create table suppliers(sid char(2) primary key,sname varchar2(15) not null unique,city varchar2(15),stelephone char(12));
